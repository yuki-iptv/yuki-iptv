...
class M3UEditor(QtWidgets.QMainWindow):
    ...
    def populate_toolbar(self):
        ...
        delete_btn.setIcon(QtGui.QIcon(
            str(Path('astroncia', self.data['icons_folder'], 'trash.png'))
        ))
        ...
        add_btn.setIcon(QtGui.QIcon(
            str(Path('astroncia', self.data['icons_folder'], 'plus.png'))
        ))
        ...
        down_btn.setIcon(QtGui.QIcon(
            str(Path('astroncia', self.data['icons_folder'], 'arrow-down.png'))
        ))
        ...
        up_btn.setIcon(QtGui.QIcon(
            str(Path('astroncia', self.data['icons_folder'], 'arrow-up.png'))
        ))

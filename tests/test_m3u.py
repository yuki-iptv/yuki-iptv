...
def test_m3u():
    data = [
        ...
        [Path('tests', 'm3u', '1.m3u'), "http://127.0.0.1/0", [
            {
                'catchup': 'default',
                'catchup-days': '1',
                'catchup-source': '',
        ...
        [Path('tests', 'm3u', '3.m3u'), "http://127.0.0.1/example.xml.gz", [
            {
                'catchup': 'default',
                'catchup-days': '1',
                'catchup-source': '',
        ...
        [Path('tests', 'm3u', '4.m3u'), "http://127.0.0.1/example.xml.gz", [
            {
                'catchup': 'default',
                'catchup-days': '1',
                'catchup-source': '',
        ...
        [Path('tests', 'm3u', '6.m3u'), "http://127.0.0.1/example6.xml.gz", [
            {
                'catchup': 'default',
                'catchup-days': '1',
                'catchup-source': '',
        ...
        [Path('tests', 'm3u', '7.m3u'), "", [
            {
                ...
                'useragent': 'Example/1.0 (Example; example) Example/1.0 (Example) Example/111'
            }
        ]],
